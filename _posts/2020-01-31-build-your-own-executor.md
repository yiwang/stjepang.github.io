...
However, that was a white lie — it took us *years* till we actually got single-allocation tasks. Consider that `tokio` 0.1 spawns by [allocating the future](https://github.com/tokio-rs/tokio/blob/a05e5a7723df5296284289505d645ee3efd3b502/tokio-threadpool/src/task/mod.rs#L79), then [allocating task state](https://github.com/tokio-rs/tokio/blob/a05e5a7723df5296284289505d645ee3efd3b502/tokio-threadpool/src/sender.rs#L168), and finally [allocating a oneshot channel](https://github.com/tokio-rs/tokio/blob/a05e5a7723df5296284289505d645ee3efd3b502/tokio-threadpool/src/thread_pool.rs#L124). That’s *three* allocations per spawn!
